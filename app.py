...
st.sidebar.markdown("---")
st.sidebar.info("**💡 How to use this panel:**\n* **Confidence Level:** Be honest! A lower score tells the AI to explain things more gently.\n* **Days to Assessment:** This determines how many days your custom Sprint Plan will cover.")
...
st.write("Electromagnetics Theory can be tough, but you don't have to study alone. I am here to help you navigate the ECM420 syllabus using three unique learning tools. *(Make sure you set your Profile in the left sidebar first! Mobile users: Tap the **`>`** arrow at the top left to open the menu).*")
            ...
            with st.spinner("Reviewing your explanation like a strict but fair professor..."):
                ...
                try:
                    ...
                    response = client.messages.create(
                        ...
                        system=shared_system_instructions, messages=api_messages
                    )
