        ...
        with st.spinner("Analyzing your learning gap and checking the ECM420 syllabus..."):
            ...
            try:
                ...
                if response.candidates and response.candidates[0].content.parts:
                    ...
                    # The explicit instruction for the students!
                    st.write("Based on your study plan, please go to the YouTube playlist menu (click the list icon in the top right corner of the video player) and select the specific lecture video for your current topic!")
